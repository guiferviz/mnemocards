...
class AutoGenerateDeckUnitTestSuit(unittest.TestCase, ab):
    ...
    class TestArgs():
        def __init__(self):
            project_path = os.getcwd().split('/mnemocards')[0]
            self.data_dir = os.path.join(
                project_path, "mnemocards/tests/test_card_folder")
